  ...
  return (
    <View
      ...
      <View className="flex-1 items-center justify-center mt-36">
        ...
        <Text className="bg-transparent text-white text-5xl text-center font-normal mt-4 px-5">Дневничок</Text>
      </View>
      {children}
      <SafeAreaView className="flex items-center justify-end flex-1 pb-5">
        <Text className="bg-transparent text-white text-16 text-center font-500 px-5">{loveText}</Text>
      </SafeAreaView>
    </View>
  );
}
